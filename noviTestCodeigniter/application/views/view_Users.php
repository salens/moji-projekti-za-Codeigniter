<html>
    ...
    <body>
        ...
        <table border="2">
            ...
            <tr><th>Username</th><th>Password</th><th>Email</th><th>Delete</th><th>Edit</th></tr>          
            ...
            <tr>               
               ...
               <td><a id="delbutt" href="<?php echo base_url() . 'main/deleteUsr/' . $view['id'];?>"><?php echo " delete"?></a></td>     
